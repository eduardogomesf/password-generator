...
export function LengthController({ value, onChange }: LengthControllerProps) {
  return (
    <div className="w-full flex flex-col gap-2">
      ...
      >
        <Slider.Track
          className='relative bg-very-dark-grey flex-1 h-2'
        >
          <Slider.Range
            className='absolute h-2 bg-neon-green'
          />
        </Slider.Track>
        <Slider.Thumb
          className='block w-7 h-7 bg-white rounded-full outline-none'
        />
      </Slider.Root>
    </div>
  )
